	...
	<div class="w-full max-w-6xl flex flex-col md:flex-row items-center justify-between">
		...
		<div class="w-full md:w-1/2 max-w-md">
			...
			<form method="post">
				...
				<input
					class="w-full mb-6 px-4 py-2 rounded-md border border-gray-200 text-gray-400 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
		...
		<div class="w-full md:w-1/2 flex flex-col items-center justify-center mt-12 md:mt-0">
			<img alt="Logo of KlinikKu showing a yellow shopping cart with a blue medical box and a red cross on top"
				class="w-60 h-auto mb-6" height="180" src="assets/img/Screenshot_2025-04-24_174922-removebg-preview.png" width="240" />
