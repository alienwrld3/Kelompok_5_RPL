...
$sql = "SELECT id_transaksi, id_staff, tgl_transaksi, keterangan FROM transaksi ORDER BY tgl_transaksi DESC";
            ...
            <nav class="navbar navbar-expand navbar-white bg-white px-3 border-bottom">
                ...
                <div class="d-flex flex-grow-1 align-items-center">
                    ...
                    <div class="d-flex align-items-center">
                        <h1 class="mb-0" style="font-size: 36px; font-weight: bold;">Laporan Transaksi</h1>
                    </div>
                            ...
                            <div class="card shadow-sm border-0 h-100">
                                <div class="card-body d-flex flex-column h-100">
                                    <div class="row fw-bold border-bottom pb-2 mb-2" style="font-size: 1.02rem;">
                                        ...
                                        <div class="col-3">ID PENGGUNA</div>
                                    ...
                                    ?>
                                        <div class="row border-bottom py-2 align-items-center" style="font-size: .98rem;">
                                            <div class="col-3"><?php echo $row['id_transaksi']?></div>
                                            <div class="col-3"><?php echo $row['id_staff']?></div>
                                            <div class="col-2"><?php echo $row['tgl_transaksi']?></div>
                                            <div class="col-4"><?php echo $row['keterangan']?></div>
                                        </div>
                                    <?php
                                            }
                                        } else {
                                            echo '
                                                <div class="row border-bottom py-2 align-items-center" style="font-size: .98rem;">
                                                    ...
                                                    <div class="col-3">TIDAK</div>
                                                    <div class="col-2">DITEMUKAN</div>
                                                    <div class="col-4"> </div>
                                                </div>
                                                ';
                                        }
